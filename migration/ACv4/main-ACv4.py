...
from migration.ACv4.agent import ActorCriticv4MigrationAgent
...
def main():
    ...
    for i in range(NUM_EDGE_DC + 1):
        migration_agents.append(ActorCriticv4MigrationAgent(i, DIM_MIG_NN_INPUT))
    ...
    for itr in range(NUM_ITERATIONS):
        ...
        for epi in range(NUM_EPISODES_ITR):
            ...
            deployment_algorithm = FirstFitAlgorithm()
            migration_algorithm = ActorCriticv4MigrationAlgorithm(migration_agents, num_epi=cnt,
